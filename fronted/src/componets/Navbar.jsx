...
function Navbar() {
  ...
  return (
    ...
    <div  className='max-w-screen-2xl container mx-auto mx:px-20 px-4  fixed left-0 right-0 z-50 dark:bg-slate-900 dark:text-white' >
  ...
  <div className="navbar-start">
   ...
   <li><a href='/'>Home</a></li>
      <li><a href='/Categories_page' >Categories</a></li>
